...
class Ball extends Component {
  ...
  render() {
    ...
    if (this.props.northColors && this.props.northColors.length > 0 && this.props.northColors[0].duration > 0) {
      let styleObj = this.createNorthHemisphereStyle();
      injectStyle(styleObj, 'north');
    }
    
    if (this.props.southColors && this.props.southColors.length > 0 && this.props.southColors[0].duration > 0) {
